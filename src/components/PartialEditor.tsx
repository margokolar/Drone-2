    ...
    <div className="space-y-4">
      <div className="space-y-3">
        {partials.map((partial, index) => {
          const isPartialActive = partial.enabled
          ...
          <article
            ...
            className={clsx(
              ...
              isPartialActive ? 'border-white/10 bg-white/5' : 'border-white/10 bg-white/[0.03]',
            )}
          >
            <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
              <button
                type="button"
                className={clsx(
                  'rounded-md px-2 py-1 text-sm font-semibold transition',
            ...
            <div
              className={clsx(
                !isPartialActive &&
                  'pointer-events-none opacity-40 [&_input]:border-white/15 [&_input]:bg-white/[0.03] [&_input]:text-white/40 [&_span]:text-white/35',
              )}
            >
